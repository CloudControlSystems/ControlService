...
class TaskDataTransmitService(data_pb2_grpc.TaskDataTransmitServiceServicer):
    ...
    def TransmitTaskData(self, request, context):
        ...
        # transmission_from_task0_to_taskc = current_time - startTime
        # print('transmission_from_task0_to_taskc: ', transmission_from_task0_to_taskc/1000)
        # # write into redis
        # sid.set('taskcTime', current_time)
        ...
        if accumulatedBoolVar:
            ...
            # computation_taskc_time = current_time_after_process_data - current_time_before_process_data
            # print('computation_taskc_time: ', computation_taskc_time/1000)
