...
import os, socket, threading, json, time, sys, grpc, redis, pickle
...
class TaskDataTransmitService(data_pb2_grpc.TaskDataTransmitServiceServicer):
    ...
    def TransmitTaskData(self, request, context):
        ...
        # transmission_from_task0_to_taskb = current_time - startTime
        # print('transmission_from_task0_to_taskb: ', transmission_from_task0_to_taskb/1000)
        # # write into redis
        # sid.set('taskbTime', current_time)
        ...
        if accumulatedBoolVar:
            ...
            # computation_taskb_time = current_time_after_process_data - current_time_before_process_data
            # print('computation_taskb_time : ', computation_taskb_time /1000)
...
if __name__ == '__main__':
    ...
    inputRead = sid.get('Task0toTask2')
